...
export default function Footer() {
  return (
    <footer className="bg-pink-400 text-white py-8 rounded-t-3xl">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4">
        ...
        <div>
          <h3 className="text-lg mb-4 font-bold">Get Involved</h3>
          <ul className="space-y-2 font-bold">
        ...
        <div>
          <h3 className="text-lg mb-4 font-bold">Connect With Us</h3>
      ...
      <div className="mt-8 border-t border-white pt-8 text-center">
        <p className="font-bold">&copy; 2023 Paw Pal. All rights reserved.</p>
      </div>
    </footer>
  )
}
